<template>
  <div class="search_container searchArea">
        <el-form 
            ...
            <el-form-item label="">
                <el-input class="inputText" v-model="search_data.name" placeholder="请输入搜索企业名称"  @keyup.enter.native='onScreeoutUser("search_data")'></el-input>
            </el-form-item>
            ...
            <el-form-item class="btnRight">
                ...
                <el-button type="primary" size ="mini" icon="view" @click='oncreateAccount()'>添加</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
